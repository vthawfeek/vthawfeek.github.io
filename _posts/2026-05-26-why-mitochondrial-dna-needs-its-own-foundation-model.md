...
![Shannon entropy across 16,569 bp positions. Orange shading marks the D-loop control region (positions 16,024–576). 50 bp moving average applied. D-loop positions reach entropy ~7x higher than coding regions such as MT-ND1 or MT-CO1.](/assets/figures/positional_entropy.png)
...
![Top 20 haplogroups in the 47,000-sequence HmtDB training corpus. Haplogroup H dominates (most common European lineage). L-root haplogroups represent African ancestral lineages. The stratified split preserves this distribution across train/val/test.](/assets/figures/haplogroup_distribution.png)
