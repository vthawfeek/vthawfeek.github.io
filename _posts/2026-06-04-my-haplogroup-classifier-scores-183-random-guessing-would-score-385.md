...
![Haplogroup classification confusion matrix. 23 of 26 rows have near-zero diagonal entries, the signature of partial class collapse.](http://rokpayprsizors.files.wordpress.com/2026/06/showcase_confusion_matrix.png)
...
![Zero-shot k-NN vs fine-tuned haplogroup classification accuracy. The pre-trained embeddings, with no task-specific training, outperform the fine-tuned classifier by 27x.](http://rokpayprsizors.files.wordpress.com/2026/06/knn_haplogroup_accuracy.png)
