...
![Per-position sequence entropy across the human mitochondrial genome. The D-loop (positions ~576-16,024, wrapping through the junction) shows dramatically higher variability than protein-coding regions.](http://rokpayprsizors.files.wordpress.com/2026/06/positional_entropy-5.png)
...
![Haplogroup distribution in the HmtDB training corpus. European haplogroups (H, HV, J, T, U) are heavily overrepresented.](http://rokpayprsizors.files.wordpress.com/2026/06/haplogroup_distribution-5.png)
